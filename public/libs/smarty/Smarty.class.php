...
class Smarty
{
    ...
    /**
     * The directory where configs files are located.
     *
     * @var string
     */
     ...
     * does not need to happen unless a template or configs file is changed.
     ...
     */
    /**
     * This tells if configs file vars of the same name overwrite each other or not.
     * if disabled, same name variables are accumulated in an array.
     */
    var $config_overwrite = true;

    /**
     * This tells whether or not to automatically booleanize configs file variables.
    ...
    /**
     * This tells whether or not automatically fix newlines in configs files.
    ...
    /**
     * The class used to load configs vars.
     *
     * @var string
     */
 ...
 */
   ...
   /**
    ...
    function _smarty_include($params)
    {
        ...
        // configs vars are treated as local, so push a copy of the
